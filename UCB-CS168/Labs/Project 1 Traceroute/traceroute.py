...
class ICMP:
    ...
    def __str__(self) -> str:
        return f"ICMP (type {self.type}, code {self.code}, " + f"cksum 0x{self.cksum:x})"
...
class UDP:
    ...
    def __str__(self) -> str:
        return f"UDP (src_port {self.src_port}, dst_port {self.dst_port}, " + f"len {self.len}, cksum 0x{self.cksum:x})"
