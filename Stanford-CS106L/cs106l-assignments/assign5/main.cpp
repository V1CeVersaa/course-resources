...
void test_memory_leak_exit_code() { std::cout << MemoryDiagnostics::MemoryGuard::get_exit_code() << "\n"; }
...
void test_destructor() {
    MemoryDiagnostics::MemoryGuard guard("Did you remember to delete[] _friends inside the destructor?");
    TUser alice("Alice");
